...
<html lang="en">
    ...
    if (!isset($_GET['ok'])) {
        $jobapply1 = $_GET['jobapply1'];
        if($jobapply1==="")
        {
        $_SESSION['jobapplyid'] ="1";
        }
        else{
           $_SESSION['jobapplyid'] =$jobapply1;  
        }
        echo $_SESSION['jobapplyid'];

        $_SESSION['studentresumeid'] = $_GET['resumeid'];
        echo   $_SESSION['studentresumeid'] ;
    }
    ?>
    <script>
        var a = 5;
